...
public abstract class Violation {
    ...
    protected final int eventHashCode;

    /**
     * For subclasses only.
     */
    protected Violation(final Instant time, final OfflinePlayer player, final FixedMessage message, double level, boolean fixed, final ZoneType zoneType, final FixStyleApplicant.FixStyle fixStyle) {
        ...
        this.eventHashCode = Preconditions.checkNotNull(message).getEventHashCode();
    }
