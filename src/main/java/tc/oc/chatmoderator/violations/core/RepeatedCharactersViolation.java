...
public class RepeatedCharactersViolation extends Violation {
     ...
     */
    public RepeatedCharactersViolation(Instant time, OfflinePlayer player, FixedMessage message, double level, List<String> repeatedCharacters, ZoneType zoneType) {
